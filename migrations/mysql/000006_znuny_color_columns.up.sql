...
-- Set default colors for standard priorities (matching Znuny initial_insert.mysql.sql)
...
-- Set default colors for standard states (matching Znuny initial_insert.mysql.sql)
